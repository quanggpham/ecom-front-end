CREATE DATABASE  IF NOT EXISTS `ecom_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ecom_db`;
...
INSERT INTO `addresses` VALUES (1,'122 Đường ABC, Phường XYZ','TP. Hồ Chí Minh',NULL,'Quận 1',_binary '',3,'2026-03-12 11:08:10.000000','0901234567','Nguyễn Văn A 12312'),(2,'123 Đường ABC, Phường XYZ','TP. Hồ Chí Minh',NULL,'Quận 1',_binary '\0',3,NULL,'0901234567','Nguyễn Văn A dia chi 2'),(3,'123 Đường ABC, Phường XYZ','TP. Hồ Chí Minh',NULL,'Quận 1',_binary '',3,NULL,'0901234567','Nguyễn Văn A dia chi 3'),(4,'số 1','Hà Nội',NULL,'Hà Đông',_binary '\0',5,NULL,'0971760561','tao'),(5,'123 Main St','HCM',NULL,'District 1',_binary '',1,NULL,'0901234567','admin'),(6,'số 2','Hà Nội',NULL,'Hà Nội',_binary '',5,NULL,'0971760561','tao 2'),(7,'heheheh',' ha noi',NULL,'ha dong',_binary '\0',5,NULL,'0971760561','dia chi 3'),(8,'ádfasd','123123',NULL,'123123',_binary '\0',5,NULL,'0971760561','dia chi 3'),(9,'heheheh',' ha noi',NULL,'ha dong',_binary '\0',5,NULL,'0971760561','dia chi 3'),(10,'heheheh',' ha noi',NULL,'ha dong',_binary '\0',5,NULL,'0971760561','dia chi 4'),(11,'ha noi','bac giang',NULL,'ha noi',_binary '\0',14,NULL,'0971760561','tao'),(12,'bac giang','sai gon',NULL,'kien giang',_binary '',14,NULL,'0971760561','me may'),(13,'heheheh',' ha noi',NULL,'ha dong',_binary '\0',1,NULL,'0971760561','dia chi 3');
...
CREATE TABLE `banners` (
  ...
  `badge_icon` enum('FLAME','GIFT','NONE','STAR','TAG') DEFAULT NULL,
...
INSERT INTO `banners` VALUES (2,_binary '','FLAME','Đậm đà','2026-04-08 08:00:40.797773','Nước dùng trong veo, ngọt thanh từ xương hầm 12 giờ cùng quế, hồi, thảo quả thơm nồng.',0,NULL,'https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775610037/qc3ddpx0sr68sqmmuuvj.jpg',NULL,'from-red-500/80',NULL,'Tinh hoa ẩm thực Việt','Phở Bò Gia Truyền','2026-04-09 07:36:44.123028'),(3,_binary '','STAR','Best Seller','2026-04-08 08:09:40.317211','Nước dùng thanh ngọt từ xương ống, đậm đà vị mắm ruốc Huế chuẩn vị cung đình',2,NULL,'https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775610585/eclnku4247wjsumr1fj3.jpg',NULL,'from-red-500/80',NULL,'Hương vị truyền thống','Bún bò Huế','2026-04-09 07:35:28.917011'),(4,_binary '','FLAME','Giòn nóng','2026-04-08 08:33:41.346284','Thịt nướng thơm lừng trên than hồng, kết hợp cùng đồ chua giòn ngọt và nước sốt đặc chế đậm đà.',3,NULL,'https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775695046/aab4ozeffcsuowtdb9mw.jpg',NULL,'from-amber-500/80',NULL,'Bánh Mì Thịt Nướng','Bánh mì thịt nướng','2026-04-09 07:37:57.343029');
...
--
-- Table structure for table `cart_reminder_logs`
--

DROP TABLE IF EXISTS `cart_reminder_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cart_reminder_logs` (
  ...
  `user_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK2ca3yay8sm5xx8t1qh258i914` (`cart_id`),
  KEY `FKl7gheg147te52t346po2tg27a` (`user_id`),
...
--
-- Dumping data for table `cart_reminder_logs`
--

LOCK TABLES `cart_reminder_logs` WRITE;
/*!40000 ALTER TABLE `cart_reminder_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `cart_reminder_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `coupons` VALUES (1,_binary '','GIAM50K_UPDATE','2026-03-09','2026-04-09 06:47:30.000000','FIXED_AMOUNT',60000.00,'2026-12-31',60000.00,250000.00,'2026-03-09',500,0,'ORDER',NULL,NULL),(2,_binary '','GIAM20PT','2026-03-09','2026-03-11 18:59:29.000000','PERCENTAGE',20.00,'2026-03-24',30000.00,100000.00,'2026-02-27',50,0,'CATEGORY',NULL,NULL),(3,_binary '','GIAM50K3','2026-03-09','2026-04-09 06:48:09.000000','FIXED_AMOUNT',50000.00,'2026-04-30',50000.00,200000.00,'2026-03-09',100,1,'ORDER',NULL,NULL),(4,_binary '','GIAM50K31','2026-03-11','2026-04-09 06:48:07.000000','FIXED_AMOUNT',50000.00,'2026-04-30',50000.00,200000.00,'2026-03-09',100,0,'ORDER',NULL,NULL),(5,_binary '','SALE20PT','2026-03-11','2026-04-09 06:48:10.000000','PERCENTAGE',20.00,'2026-05-01',30000.00,100000.00,'2026-03-09',50,1,'ORDER',NULL,NULL),(6,_binary '\0','TEST123','2026-03-12','2026-04-09 06:48:12.000000','PERCENTAGE',15.00,'2026-12-31',30000.00,100000.00,'2026-03-12',50,0,'CATEGORY',NULL,NULL),(7,_binary '','MONNUOC20','2026-04-09',NULL,'PERCENTAGE',20.00,'2026-09-09',20000.00,60000.00,'2026-04-08',100,0,'CATEGORY',1,NULL),(8,_binary '','123','2026-04-09','2026-04-09 06:52:05.000000','FIXED_AMOUNT',123.00,'2029-11-11',0.00,123.00,'2026-04-08',100,0,'ORDER',NULL,NULL),(9,_binary '','COMTRUA30','2026-04-09',NULL,'FIXED_AMOUNT',30000.00,'2027-11-11',0.00,80000.00,'2026-04-08',100,0,'CATEGORY',2,NULL),(10,_binary '','KHAITRUONG30','2026-04-09',NULL,'FIXED_AMOUNT',30000.00,'2027-11-11',0.00,50000.00,'2026-04-08',100,0,'ORDER',NULL,NULL);
...
CREATE TABLE `orders` (
  ...
  `payment_method` enum('COD','BANK_TRANSFER','CREDIT','VNPAY','MOMO','SEPAY','STRIPE') DEFAULT NULL,
...
CREATE TABLE `product_likes` (
  ...
  `user_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK712hmqku6f5l2q28jql7vj0f5` (`user_id`,`product_id`),
  KEY `FK795q9hiytbh68mn8om6hmxpoa` (`product_id`),
...
INSERT INTO `products` VALUES (1,'2026-04-09 06:18:24.000000',NULL,'Nước dùng hầm xương bò nhiều giờ cho vị ngọt thanh tự nhiên, bánh phở mềm dai và thịt bò tái lăn vừa chín tới. Món ăn mang hương vị gia truyền, ấm bụng và dễ ăn cho mọi thời điểm trong ngày.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690432/pi23ipovb6qjcytwd5b8.jpg',_binary '','Phở Bò Truyền Thống',55000.00,118,'2026-04-12 10:22:53.549654',1),(2,'2026-04-09 06:18:24.000000',NULL,'Bún bò chuẩn vị Huế với mùi sả thơm nồng, chút mắm ruốc đặc trưng, nước dùng đậm đà cay nhẹ. Ăn kèm chả cua dai giòn và móng giò béo ngậy, rất hợp cho người thích món nước đậm vị.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690444/wqtmf9fls9ntkpf7xaph.jpg',_binary '','Bún Bò Huế',60000.00,91,'2026-04-12 10:22:53.543392',1),(3,'2026-04-09 06:18:24.000000',NULL,'Sợi hủ tiếu dai mềm, nước dùng thanh ngọt từ xương và hải sản, kết hợp tôm, mực tươi và thịt bằm xào tỏi thơm lừng. Hương vị nhẹ nhàng, dễ ăn nhưng vẫn rất tròn vị.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690506/to8yrooplavvflpyhghf.png',_binary '','Hủ Tiếu Nam Vang',50000.00,95,'2026-04-12 10:22:53.545950',1),(4,'2026-04-09 06:18:24.000000',NULL,'Nước dùng chua thanh từ cà chua và giấm bỗng, riêu cua béo bùi, đậu phụ chiên vàng và rau sống tươi xanh. Món ăn cân bằng vị giác, phù hợp cho bữa trưa thanh đạm mà vẫn no bụng.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690639/hbeqnxdmfoculquk3kgc.jpg',_binary '','Bún Riêu Cua',45000.00,106,'2026-04-12 10:22:53.548456',1),(5,'2026-04-09 06:18:24.000000',NULL,'Sợi mì nghệ vàng óng, thịt ếch rim đậm vị, thơm mùi hành tỏi và tiêu. Ăn kèm rau mầm, bánh tráng nướng giòn và chút nước dùng xâm xấp đúng kiểu miền Trung.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690698/euznxg1ao5mf2agydzam.jpg',_binary '','Mì Quảng Ếch',65000.00,80,'2026-04-09 06:24:37.105680',1),(6,'2026-04-09 06:18:24.000000',NULL,'Cơm tấm nóng dẻo ăn cùng sườn nướng than hoa thơm lừng, bì heo dai giòn và chả trứng mềm béo. Chan thêm nước mắm tỏi ớt chua ngọt là tròn vị đúng chuẩn Sài Gòn.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690746/fvlsj3c1gv5qgpgjbtcu.jpg',_binary '','Cơm Tấm Sườn Bì Chả',60000.00,128,'2026-04-09 10:55:10.462063',2),(7,'2026-04-09 06:18:24.000000',NULL,'Hạt cơm tơi xốp rang trên chảo lớn, quyện với tôm, mực và rau củ cắt hạt lựu. Món ăn thơm mùi chảo, vị vừa miệng, thích hợp cho người thích cơm rang đậm đà.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690780/vfgegyhzqstukfarx2a8.jpg',_binary '','Cơm Chiên Hải Sản',70000.00,89,'2026-04-09 10:42:45.766478',2),(8,'2026-04-09 06:18:24.000000',NULL,'Đùi gà xối mỡ vàng giòn bên ngoài nhưng thịt bên trong vẫn mềm mọng, ăn cùng cơm rang nghệ thơm nhẹ. Đi kèm nước tương tỏi ớt và đồ chua giúp món ăn không bị ngấy.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690810/rypfgaiw7crk53o8ujlc.jpg',_binary '','Cơm Gà Xối Mỡ',55000.00,105,'2026-04-09 06:26:32.799151',2),(9,'2026-04-09 06:18:24.000000',NULL,'Thịt ba chỉ kho mềm rục trong nước màu óng đẹp, trứng cút thấm vị mặn ngọt hài hòa. Hương vị thân thuộc, rất hợp dùng cùng cơm nóng cho bữa ăn gia đình.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690868/luxyxicgvz6nnhb3pfoe.jpg',_binary '','Thịt Kho Tàu Trứng Cút',45000.00,84,'2026-04-09 06:41:48.092699',2),(10,'2026-04-09 06:18:24.000000',NULL,'Cá lóc thịt chắc kho tộ với tiêu đen, ớt hiểm và nước màu keo sánh, dậy mùi hấp dẫn. Đây là món mặn cực kỳ đưa cơm, mang phong vị dân dã miền quê.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690885/xxgltzryy1w5nqk2ghj2.webp',_binary '','Cá Lóc Kho Tộ',50000.00,72,'2026-04-09 10:23:36.441042',2),(11,'2026-04-09 06:18:24.000000',NULL,'Đế bánh mỏng giòn, phủ phô mai mozzarella béo ngậy cùng tôm, mực và xốt cà chua thơm dịu. Một món ăn nhanh hiện đại nhưng vẫn rất hợp khẩu vị số đông.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690917/u98svibopxkfklou6fyv.jpg',_binary '','Pizza Hải Sản Phô Mai',120000.00,58,'2026-04-09 10:23:36.443039',3),(12,'2026-04-09 06:18:24.000000',NULL,'Combo 3 miếng gà rán với lớp vỏ giòn rụm, phủ bột cay nhẹ kích thích vị giác. Thịt gà bên trong mềm mọng, phù hợp cho bữa ăn nhanh hoặc ăn cùng bạn bè.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690939/fnz0ceei9wujpzo8zack.jpg',_binary '','Gà Rán Giòn Cay',85000.00,1,'2026-04-09 10:28:30.100329',3),(13,'2026-04-09 06:18:24.000000',NULL,'Rau xà lách tươi giòn, ức gà luộc mềm ẩm, thêm cà chua bi và sốt mè rang béo bùi. Món ăn healthy thanh đạm, phù hợp cho người đang ăn cân bằng hoặc tập luyện.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690969/m83osklqog4ff0shyiqm.jpg',_binary '','Salad Ức Gà Xốt Mè Rang',65000.00,70,'2026-04-09 06:29:10.667335',3),(14,'2026-04-09 06:18:24.000000',NULL,'Bánh mì giòn xốp, kẹp thịt nướng sả đậm đà, pate gan béo nhẹ, đồ chua và rau thơm. Món ăn nhanh quen thuộc nhưng luôn hấp dẫn nhờ hương vị hài hòa.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775690987/p9azhtuqk8jcllt8fwu8.jpg',_binary '','Bánh Mì Thịt Nướng',30000.00,150,'2026-04-09 06:29:28.700779',3),(15,'2026-04-09 06:18:24.000000',NULL,'Tôm luộc đỏ au, thịt ba chỉ thái mỏng, bún tươi và rau sống được cuốn gọn trong lớp bánh tráng mềm. Dùng kèm tương chấm bùi béo, thanh mát và rất dễ ăn.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775691009/ekkblnskauhotvrh7qru.jpg',_binary '','Gỏi Cuốn Tôm Thịt',35000.00,140,'2026-04-09 06:29:51.562702',3),(16,'2026-04-09 06:18:24.000000',NULL,'Trà đen thơm dịu hòa cùng sữa tươi béo nhẹ, kết hợp trân châu đường đen dẻo dai ngọt vừa. Thức uống được nhiều khách hàng yêu thích nhờ vị đậm nhưng không gắt.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775691029/eucuni1okcxbabwlg2rq.jpg',_binary '','Trà Sữa Trân Châu Đường Đen',45000.00,180,'2026-04-09 06:30:09.672796',4),(17,'2026-04-09 06:18:24.000000',NULL,'Cà phê Robusta pha phin đậm đà, hòa cùng sữa đặc béo thơm và đá viên mát lạnh. Hương vị quen thuộc giúp tỉnh táo và rất hợp để dùng buổi sáng.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775691049/rorf7hcqtr8rbfckujuc.jpg',_binary '','Cà Phê Sữa Đá',25000.00,200,'2026-04-09 06:30:31.024587',4),(18,'2026-04-09 06:18:24.000000',NULL,'Nước ép dưa hấu tươi nguyên chất, vị ngọt thanh tự nhiên, mát lạnh và dễ uống. Phù hợp để giải nhiệt và bổ sung nước trong những ngày thời tiết nóng.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775691076/d4xntt69q4psjdm7apba.jpg',_binary '','Nước Ép Dưa Hấu',30000.00,160,'2026-04-09 06:30:59.103995',4),(19,'2026-04-09 06:18:24.000000',NULL,'Đậu xanh mềm bùi, cùi bưởi giòn sần sật không đắng, chan cùng nước cốt dừa sánh béo. Món tráng miệng truyền thống có vị ngọt vừa và kết cấu rất thú vị.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775691100/ohyji6kcywkzfsnvlo2l.jpg',_binary '','Chè Bưởi Cốt Dừa',25000.00,120,'2026-04-09 06:31:23.764765',4),(20,'2026-04-09 06:18:24.000000',NULL,'Bánh flan mềm mịn làm từ trứng và sữa tươi, phủ lớp caramel thơm nhẹ hơi đăng đắng. Món tráng miệng đơn giản nhưng dễ chiều lòng nhiều thực khách.','https://res.cloudinary.com/dgxvoyfyv/image/upload/v1775691125/f6wrwx0axdalzmnlx7cp.webp',_binary '','Bánh Flan Caramel',20000.00,130,'2026-04-09 06:31:43.660542',4);
...
CREATE TABLE `reviews` (
  ...
  `seller_reply` text,
  `seller_reply_at` datetime(6) DEFAULT NULL,
  `status` enum('APPROVED','PENDING','REJECTED') NOT NULL,
  `updated_at` datetime(6) DEFAULT NULL,
  `order_detail_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKpdoxdvhk6k612mlg4cdpr6rgn` (`order_detail_id`),
...
-- Dump completed on 2026-05-20 10:37:29
